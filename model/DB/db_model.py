...
class DB:
    ...
    def insert_blast_result(self, table_name, csv_file):
        insert_query = f"""
        ...
        base_folder_path = "blast_results"
        ...
        for idx, row in df.iterrows():
            ...
            qseq_path = os.path.join(base_folder_path, folder_path, f"{self.gene}_{genome_name}_qseq_{idx}.fasta")
            sseq_path = os.path.join(base_folder_path, folder_path, f"{self.gene}_{genome_name}_sseq_{idx}.fasta")
